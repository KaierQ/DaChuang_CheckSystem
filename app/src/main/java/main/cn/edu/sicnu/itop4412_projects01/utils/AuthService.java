...
public class AuthService {
	...
	private static final String path = Environment.getExternalStorageDirectory()+ File.separator+"check";
	...
	public static String getAuth() {
		...
		String clientId = "yNYtItUZL5yynzqeW4NtyTEz";
		// 官网获取的 Secret Key 更新为你注册的
		String clientSecret = "Rh6uZPcBa4939GyGb7rePUXAlfUrZmDR";
...
//			String image2 = Base64Util.encode(bytes2);
	 ...
	 * @return
	 */
	public static String match(String rawImgPath,String identifyImgPath) {
			// 请求url
			String url = "https://aip.baidubce.com/rest/2.0/face/v3/match";
			try {
